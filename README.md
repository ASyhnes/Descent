...
La réalité, telle que nous l'entendons, est régie par un ensemble de règles mathématiques qui permettent de la définir. Tout a commencé lorsqu'un scientifique a eu une fulgurante intuition : et si les abeilles ne faisaient pas des alvéoles triangulaires à la base... ? C'est à partir de cette faille fondamentale que l'Other Frequencies Institute (OFI) a été poussé à étudier l'**anthropie** de ces règles *(en résonance au Principe Anthropique Participatif défini par le physicien **John Archibald Wheeler**, postulant que l'univers nécessite un observateur conscient pour exister formellement)*. 

La problématique vertigineuse soulevée par cette anthropie est celle-ci : la transformation des règles de la réalité est humainement imperceptible, car elle implique une refonte de leur propre définition au sein même de notre observation. L'étude de ce phénomène insaisissable par l'OFI a ouvert de très nombreuses portes d'un point de vue technologique, menant l'humanité à redéfinir jusqu'à la définition même de la conscience.
